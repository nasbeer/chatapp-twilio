$(function() {
  ...
  function printMessage(fromUser, message) {
    var $icon = $('<i class="fa fa-user-circle fa-2x"></i>');
    var $user = $('<span class="username" style="padding-top:2px;"> ').text(fromUser + ':');
    var $space = $('<br/>');
    var $container = $('<div class="message-container" >');
    if (fromUser === username) {
      $user.addClass('me');
     // $icon.addClass('me');
      $container.addClass('bg-me');
    }else{
      $container.addClass('pull-right');
    }
    var $message = $('<span class="message" style="padding-top:2px;">').text(message);
    
    $container.append($icon).append($user).append($space).append($message);
  ...
  $.getJSON('/token', function(data) {
    ...
    print('You are logged in as a random username of: '
